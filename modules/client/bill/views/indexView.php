...
<body>
    ...
    ?>
        ...
        <?php foreach ($notifications as $notification) : ?>
            <div class="error_booking" style="padding : 100px;">
  ...
  margin-bottom: 15px;" class="alert alert-<?php echo $notification['type'] ?>" role="alert"><?php echo $msg ?></div>
    ...
    <div class="content" style="padding: 150px 0px; width: 1200px; margin: auto;">
        ...
        <table class="table" border="0">
            ...
            <tbody>
                <?php foreach ($bills as $bill => $value) : ?>
                    <tr>
                        <th scope="col"><?= $value['id_bill'] ?></th>
                        <th><?= $value['id_user'] ?></th>
                        <th><?= $value['id_phong'] ?></th>
                        <th><?= $value['ngay_thue'] ?></th>
                        <th><?= $value['ngay_tra'] ?></th>
                        <th><?= $value['name'] ?></th>
                        <th><img style="width: 100px;" src="public/uploads/<?= $value['thumb'] ?> " alt=""></th>
                        <th><?= $value['price'] ?></th>
                        <th><?= $value['tong_tien'] ?></th>
                        ...
                        <th>
                            ...
                            <?php } else { ?><a href="?role=client&mod=bill&id_user=<?= $_GET['id_user']; ?>&action=delete&id_bill=<?= $value['id_bill'] ?>">

    ...
    <div class="login-signup-box">
      ...
      <div class="login__form--box">
        <div class="header__form--box">
          ...
          <p class="header__title--box">Đăng nhập</p>
        </div>
        <div class="body__form--box">
          ...
          <form action="" class="login--form" method="post">
            <div class="form-control">
              ...
              <input type="text" name="email" class="form-input-fill">
            </div>
            <div class="form-control">
              <div class="form-input-label-box">
                <label class="form-input-label">Mật khẩu</label>
              </div>
              <input type="password" name="password" class="form-input-fill">
            </div>
            <div class='exportErr'>
        ...
        <div class="button">
        <button type="submit" name="submit-btn" class="submit-btn">Đăng nhập</button>
       
     <a href="?role=client&mod=auth&action=register">
     
      <input type="button" class="submit-btn" value="Đăng ký">
        ...
        <p>Bạn quên mật khẩu? Khôi phục tài khoản ngay <a href="">Tại đây!</a></p>

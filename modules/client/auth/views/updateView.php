...
<div class="content2">
            <div class="breadcrumb">
                <p class="breadcrumb-title"><a href="./index.php">Trang chủ</a> - Thông tin cá nhân - Chỉnh sửa thông tin cá nhân</p>
            </div>
                ...
                <div class="info--menu__img--box">
                    ...
                    <div class="info--menu__username--box">
                        ...
                        <div class="info--menu__function">
                            ...
                            <input type="text" name="thumbs" hidden value="<?= $user['thumb']?>">
                              <input type="file" class="info--menu__function--link" name="thumb">
            ...
            <div class="section__info--display">
                    ...
                    <div class="section__info--display--box">
                        ...
                        <p class="section__info--display--textContent">
                            ...
                            <input type="text" value="<?= $user['full_name']?>" class="info--menu__function--link" name="name">
                        </p>
                    </div>
                    <div class="section__info--display--box">
                        ...
                        <p class="section__info--display--textContent">
                        <p class="section__info--display--textContent">
                            <input type="text" value="<?= $user['email']?>" class="info--menu__function--link" name="email">
                    ...
                    <div class="section__info--display--box">
                        ...
                        <p class="section__info--display--textContent">
                        <p class="section__info--display--textContent">
                            <input type="text" value="<?= $user['numberphone']?>" class="info--menu__function--link" name="phone">
                    ...
                    <div class="section__info--display--box">
                        ...
                        <p class="section__info--display--textContent">
                           <input type="text" value="<?= $user['password']?>" class="info--menu__function--link"  name="password" >

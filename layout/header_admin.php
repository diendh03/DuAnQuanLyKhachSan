				...
				<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
					...
					<ul class="menu-nav">
						...
						<li class="menu-item" aria-haspopup="true">
							<a href="?role=admin&mod=loaiphong" class="menu-link">
								<span class="svg-icon menu-icon">
								...
								<span class="menu-text">Danh sách loại phòng</span>
							</a>
						</li>
						
						<li class="menu-item" aria-haspopup="true">
							<a href="?role=admin&mod=phong" class="menu-link">
								<span class="svg-icon menu-icon">
									<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<span class="menu-text">Danh sách phòng</span>
							</a>
						</li>
						...
						<li class="menu-item" aria-haspopup="true">
							<a href="?role=admin&mod=bills" class="menu-link">
								<span class="svg-icon menu-icon">
									<!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<span class="menu-text">Danh sách hóa đơn</span>
							</a>
						</li>
						<li class="menu-item" aria-haspopup="true">
